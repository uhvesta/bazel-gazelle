...
http_archive(
    ...
    urls = [
        "https://mirror.bazel.build/github.com/uhvesta/bazel-gazelle/releases/download/v0.35.0/bazel-gazelle-v0.35.0.tar.gz",
        "https://github.com/uhvesta/bazel-gazelle/releases/download/v0.35.0/bazel-gazelle-v0.35.0.tar.gz",
    ],
)
