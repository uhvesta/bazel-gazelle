...
GO_REPOSITORY_TOOLS_SRCS = [
    ...
    Label("//v3:BUILD.bazel"),
    Label("//v3/cmd:BUILD.bazel"),
    Label("//v3/cmd/gazelle:BUILD.bazel"),
    Label("//v3/cmd/gazelle:langs.go"),
    Label("//v3/cmd/gazelle:main.go"),
    Label("//v3/internal:BUILD.bazel"),
    ...
    Label("//v3/language/go:build_constraints.go"),
    Label("//v3/language/go:config.go"),
    Label("//v3/language/go:constants.go"),
    Label("//v3/language/go:embed.go"),
    Label("//v3/language/go:fileinfo.go"),
    Label("//v3/language/go:fix.go"),
    Label("//v3/language/go:generate.go"),
    Label("//v3/language/go:kinds.go"),
    Label("//v3/language/go:lang.go"),
    Label("//v3/language/go:package.go"),
    Label("//v3/language/go:platform_info.go"),
    Label("//v3/language/go:resolve.go"),
    Label("//v3/language/go:std_package_list.go"),
    Label("//v3/language/go:stdlib_links.go"),
    Label("//v3/language/go:utils.go"),
    Label("//v3/language/go:vfs.go"),
    Label("//v3/language:lang.go"),
    Label("//v3/language/proto:BUILD.bazel"),
    Label("//v3/language/proto:config.go"),
    Label("//v3/language/proto:constants.go"),
    Label("//v3/language/proto:fix.go"),
    Label("//v3/language/proto:generate.go"),
    Label("//v3/language/proto:kinds.go"),
    Label("//v3/language/proto:known_imports.go"),
    Label("//v3/language/proto:known_proto_imports.go"),
    Label("//v3/language/proto:package.go"),
    Label("//v3/language/proto:proto.go"),
    Label("//v3/language/proto:resolve.go"),
    Label("//v3/language:registry.go"),
    Label("//v3/run:BUILD.bazel"),
    Label("//v3/run:run.go"),
    Label("//v3/walk:BUILD.bazel"),
    Label("//v3/walk:config.go"),
    Label("//v3/walk:walk.go"),
