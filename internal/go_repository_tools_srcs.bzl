...
GO_REPOSITORY_TOOLS_SRCS = [
    ...
    Label("//internal/bzlmod/tools:tools.go"),
    ...
    Label("//v2/cmd/gazelle/update:diff.go"),
    Label("//v2/cmd/gazelle/update:fix.go"),
    Label("//v2/cmd/gazelle/update:metaresolver.go"),
    ...
    Label("//vfsgazelle:BUILD.bazel"),
    Label("//vfsgazelle/cmd:BUILD.bazel"),
    Label("//vfsgazelle/cmd/gazelle:BUILD.bazel"),
    Label("//vfsgazelle/cmd/gazelle:langs.go"),
    Label("//vfsgazelle/cmd/gazelle:main.go"),
    Label("//vfsgazelle/internal:BUILD.bazel"),
    Label("//vfsgazelle/internal/vfs:BUILD.bazel"),
    Label("//vfsgazelle/internal/vfs:cache.go"),
    Label("//vfsgazelle/internal/vfs:doc.go"),
    Label("//vfsgazelle/internal/vfs:repo.go"),
    Label("//vfsgazelle/internal/vfs:state.go"),
    Label("//vfsgazelle/language:BUILD.bazel"),
    Label("//vfsgazelle/language:base.go"),
    Label("//vfsgazelle/language:doc.go"),
    Label("//vfsgazelle/language/go:BUILD.bazel"),
    Label("//vfsgazelle/language/go:build_constraints.go"),
    Label("//vfsgazelle/language/go:config.go"),
    Label("//vfsgazelle/language/go:constants.go"),
    Label("//vfsgazelle/language/go:embed.go"),
    Label("//vfsgazelle/language/go:fileinfo.go"),
    Label("//vfsgazelle/language/go:fix.go"),
    Label("//vfsgazelle/language/go:generate.go"),
    Label("//vfsgazelle/language/go:kinds.go"),
    Label("//vfsgazelle/language/go:lang.go"),
    Label("//vfsgazelle/language/go:package.go"),
    Label("//vfsgazelle/language/go:platform_info.go"),
    Label("//vfsgazelle/language/go:resolve.go"),
    Label("//vfsgazelle/language/go:std_package_list.go"),
    Label("//vfsgazelle/language/go:stdlib_links.go"),
    Label("//vfsgazelle/language/go:utils.go"),
    Label("//vfsgazelle/language/go:vfs.go"),
    Label("//vfsgazelle/language:lang.go"),
    Label("//vfsgazelle/language/proto:BUILD.bazel"),
    Label("//vfsgazelle/language/proto:config.go"),
    Label("//vfsgazelle/language/proto:constants.go"),
    Label("//vfsgazelle/language/proto:fix.go"),
    Label("//vfsgazelle/language/proto:generate.go"),
    Label("//vfsgazelle/language/proto:kinds.go"),
    Label("//vfsgazelle/language/proto:known_imports.go"),
    Label("//vfsgazelle/language/proto:known_proto_imports.go"),
    Label("//vfsgazelle/language/proto:package.go"),
    Label("//vfsgazelle/language/proto:proto.go"),
    Label("//vfsgazelle/language/proto:resolve.go"),
    Label("//vfsgazelle/language:registry.go"),
    Label("//vfsgazelle/run:BUILD.bazel"),
    Label("//vfsgazelle/run:doc.go"),
    Label("//vfsgazelle/run:run.go"),
    Label("//vfsgazelle/walk:BUILD.bazel"),
    Label("//vfsgazelle/walk:config.go"),
    Label("//vfsgazelle/walk:doc.go"),
    Label("//vfsgazelle/walk:walk.go"),
