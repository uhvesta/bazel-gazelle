...
// BaseLang implements the minimum of the vfsgazelle language.Language interface.
//
// This is intended for composition by downstream vfsgazelle languages so they can
