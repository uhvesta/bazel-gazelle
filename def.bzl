...
DEFAULT_VFSGAZELLE_LANGUAGES = _DEFAULT_VFSGAZELLE_LANGUAGES
# Backward-compatible alias while the rename settles.
DEFAULT_V3_LANGUAGES = DEFAULT_VFSGAZELLE_LANGUAGES
